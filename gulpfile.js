...
import { csv } from './gulp/tasks/csv.js';
import { pathsExport } from './gulp/tasks/pathsExport.js';
...
function watcher() {
  ...
  gulp.watch(`${srcFolder}/guide/**/*.csv`, csv);
}
 ...
 * 개발 모드의 병렬 작업
 * */
const devTasks = gulp.parallel(copy, csv, pathsExport, handleSCSS, handleJS, handleImages, handleFonts);
/**
 * 빌드 모드의 병렬 작업
 * */
 ...
 * 스크립트 내보내기
 * */
export { dev, build, backupZIP, checkhtml, checkstyle, svg, colorServerTask, fonts };
